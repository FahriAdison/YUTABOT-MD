...
const useragents_json_1 = __importDefault(require("../assets/useragents.json"));
class Util {
    ...
    static getRandomUA() {
        return useragents_json_1.default[Math.floor(Math.random() * useragents_json_1.default.length)];
    }
